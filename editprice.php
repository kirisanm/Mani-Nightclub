  ...
  <body>
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-black border-bottom shadow-sm">
	 <a href="index.php"><img src="pic/night.png" width="175"></a> &nbsp;&nbsp;&nbsp;
      <nav class="my-0 mr-md-auto my-2 my-md-0 mr-md-3">
		...
		<a class="btn btn-outline-warning" href="signin.php"><font color="white">Sign in</font></a> &nbsp;
		<a class="btn btn-outline-warning" href="signup.php"><font color="white">Sign up</font></a>
    </div>
	...
	<nav class="navbar navbar-light">
	  <a class="navbar-brand" href="desktop.php">
		<img src="pic/ikon.ico" width="30" height="30" class="d-inline-block align-top" alt="">
...
<footer class="pt-4 my-md-5 pt-md-5 border-top">
	...
	<link rel="stylesheet" href="style/css/styledesktop.css">
    <script>
